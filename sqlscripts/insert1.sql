...
INSERT INTO MEMBER(USERNAME,FIRSTNAME,LASTNAME,EMAIL,PASSWORD,GENDER, LEVEL, EXPERIENCE) VALUES('ouams','Ouamar','Sais','ouams@gmail.com','ouams','M', 3, 350);
...
/* -------------------- INSERT LEVEL -------------------- */
INSERT INTO LEVEL(LABEL_LVL, LEVEL_PIC,XP_MIN,XP_MAX) VALUES('Nouveau cuisinier',1, 0, 50);
INSERT INTO LEVEL(LABEL_LVL, LEVEL_PIC,XP_MIN,XP_MAX) VALUES('Casseur d oeuf',1, 50, 100);
INSERT INTO LEVEL(LABEL_LVL, LEVEL_PIC,XP_MIN,XP_MAX) VALUES( 'Cuisinier toqué',1, 100, 200);
INSERT INTO LEVEL(LABEL_LVL, LEVEL_PIC,XP_MIN,XP_MAX) VALUES( 'Commis de cuisine',1, 200, 350);
INSERT INTO LEVEL(LABEL_LVL, LEVEL_PIC,XP_MIN,XP_MAX) VALUES( 'Chef étoilé',1, 1000, 1200);
...
/* -------------------- INSERT TASTE -------------------- */
INSERT INTO TASTE(FK_ID_MEMBER,FK_ID_INGREDIENT,GRADING) VALUES('10','11','9');
INSERT INTO TASTE(FK_ID_MEMBER,FK_ID_INGREDIENT,GRADING) VALUES('10','15','6');
INSERT INTO TASTE(FK_ID_MEMBER,FK_ID_INGREDIENT,GRADING) VALUES('10','14','10');
INSERT INTO TASTE(FK_ID_MEMBER,FK_ID_INGREDIENT,GRADING) VALUES('10','12','1');
INSERT INTO TASTE(FK_ID_MEMBER,FK_ID_INGREDIENT,GRADING) VALUES('12','11','6');
INSERT INTO TASTE(FK_ID_MEMBER,FK_ID_INGREDIENT,GRADING) VALUES('12','12','8');
INSERT INTO TASTE(FK_ID_MEMBER,FK_ID_INGREDIENT,GRADING) VALUES('12','13','9');
INSERT INTO TASTE(FK_ID_MEMBER,FK_ID_INGREDIENT,GRADING) VALUES('12','13','0');
...
INSERT INTO RECIPE(NAME,DESCRIPTION,PREPARATION_TIME,COOKING_TIME,FK_CREATOR,DISH_TYPE,DIFFICULTY, EXPERIENCE_VAL) VALUES('Omelette','Une superbe omelette baveuse',300,360,10,'Plat',0, 10);




/* -------------------- INSERT TAG_TO_INGREDIENT -------------------- */
INSERT INTO TAG_TO_INGREDIENT(FK_ID_TAG,FK_ID_INGREDIENT) VALUES('13','11');
INSERT INTO TAG_TO_INGREDIENT(FK_ID_TAG,FK_ID_INGREDIENT) VALUES('24','16');
INSERT INTO TAG_TO_INGREDIENT(FK_ID_TAG,FK_ID_INGREDIENT) VALUES('14','12');
INSERT INTO TAG_TO_INGREDIENT(FK_ID_TAG,FK_ID_INGREDIENT) VALUES('16','11');
INSERT INTO TAG_TO_INGREDIENT(FK_ID_TAG,FK_ID_INGREDIENT) VALUES('16','20');
INSERT INTO TAG_TO_INGREDIENT(FK_ID_TAG,FK_ID_INGREDIENT) VALUES('16','15');
INSERT INTO TAG_TO_INGREDIENT(FK_ID_TAG,FK_ID_INGREDIENT) VALUES('16','16');
INSERT INTO TAG_TO_INGREDIENT(FK_ID_TAG,FK_ID_INGREDIENT) VALUES('16','17');
INSERT INTO TAG_TO_INGREDIENT(FK_ID_TAG,FK_ID_INGREDIENT) VALUES('16','18');
INSERT INTO TAG_TO_INGREDIENT(FK_ID_TAG,FK_ID_INGREDIENT) VALUES('16','19');
INSERT INTO TAG_TO_INGREDIENT(FK_ID_TAG,FK_ID_INGREDIENT) VALUES('16','20');
INSERT INTO TAG_TO_INGREDIENT(FK_ID_TAG,FK_ID_INGREDIENT) VALUES('17','11');
INSERT INTO TAG_TO_INGREDIENT(FK_ID_TAG,FK_ID_INGREDIENT) VALUES('17','12');
INSERT INTO TAG_TO_INGREDIENT(FK_ID_TAG,FK_ID_INGREDIENT) VALUES('17','16');
INSERT INTO TAG_TO_INGREDIENT(FK_ID_TAG,FK_ID_INGREDIENT) VALUES('17','17');
INSERT INTO TAG_TO_INGREDIENT(FK_ID_TAG,FK_ID_INGREDIENT) VALUES('17','18');
INSERT INTO TAG_TO_INGREDIENT(FK_ID_TAG,FK_ID_INGREDIENT) VALUES('17','19');
INSERT INTO TAG_TO_INGREDIENT(FK_ID_TAG,FK_ID_INGREDIENT) VALUES('13','20');
INSERT INTO TAG_TO_INGREDIENT(FK_ID_TAG,FK_ID_INGREDIENT) VALUES('21','13');
INSERT INTO TAG_TO_INGREDIENT(FK_ID_TAG,FK_ID_INGREDIENT) VALUES('22','14');




/* -------------------- INSERT INGREDIENT_IN_RECIPE -------------------- */
INSERT INTO INGREDIENT_IN_RECIPE(FK_ID_INGREDIENT,FK_ID_RECIPE,QUANTITY,MEASUREMENT) VALUES('15','1',3,'nombre');
INSERT INTO INGREDIENT_IN_RECIPE(FK_ID_INGREDIENT,FK_ID_RECIPE,QUANTITY,MEASUREMENT) VALUES('16','1',4,'gramme');
INSERT INTO INGREDIENT_IN_RECIPE(FK_ID_INGREDIENT,FK_ID_RECIPE,QUANTITY,MEASUREMENT) VALUES('18','1',2,'gramme');
...
INSERT INTO TAG_TO_RECIPE(FK_ID_TAG,FK_ID_RECIPE) VALUES('16','1');




/* -------------------- INSERT COMMENT -------------------- */
INSERT INTO COMMENT(FK_ID_RECIPE,FK_ID_MEMBER,TITLE,DESCRIPTION) VALUES('1','12','NON!','J''aime pas baveuse. nul!');
INSERT INTO COMMENT(FK_ID_RECIPE,FK_ID_MEMBER,TITLE,DESCRIPTION) VALUES('1','11','OSEF','Mdr t''as qu''à la laisser plus longtemps');




/* -------------------- INSERT NOTE -------------------- */
INSERT INTO NOTE(FK_ID_MEMBER,FK_ID_RECIPE,FK_ID_COMMENT,RATING) VALUES('12','1','2',2)
...
INSERT INTO ADMINISTRATOR(ID_ADMINISTRATOR,RANK) VALUES(13,'Administrateur');
INSERT INTO ADMINISTRATOR(ID_ADMINISTRATOR,RANK) VALUES(12,'Moderateur');
